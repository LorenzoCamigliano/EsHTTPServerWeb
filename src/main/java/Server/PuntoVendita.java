...
public class PuntoVendita {
    ...
    public int getIdErescente() {
        return idErescente;
    }

    public void setIdErescente(int idErescente) {
        this.idErescente = idErescente;
    }
    ...
    public PuntoVendita(int idPuntoVendita, String denominazione, String indirizzo, String cap, String comune, String codProvincia, String urlSito, String telefonoPrincipale, String telefonoSecondario, String email, String latitudine, String longitudine, boolean flagFisicoOnline, int idErescente, String ragioneSociale) {
        this.idPuntoVendita = idPuntoVendita;
        this.denominazione = denominazione;
        this.indirizzo = indirizzo;
        this.cap = cap;
